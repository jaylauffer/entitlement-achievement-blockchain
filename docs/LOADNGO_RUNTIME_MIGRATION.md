...
- peers use the bounded `eab-wire` probe/challenge/query/response exchange
- keyed cookies bind the larger response to a reachable source
- the obsolete JSON presence, detailed-status, and full-definition award
  messages have been removed
- private detailed status and claims await authenticated secure unicast
